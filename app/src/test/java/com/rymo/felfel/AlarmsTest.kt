...
import com.rymo.felfel.AlarmSchedulerTest.SetterMock
import com.rymo.felfel.DatabaseQueryMock.Companion.createStub
import com.rymo.felfel.DatabaseQueryMock.Companion.createWithFactory
import com.rymo.felfel.configuration.Prefs
import com.rymo.felfel.configuration.Prefs.Companion.create
...
import com.rymo.felfel.model.AlarmCore.IStateNotifier
...
import com.rymo.felfel.model.CalendarType
...
import com.rymo.felfel.stores.InMemoryRxDataStoreFactory
import com.rymo.felfel.util.Optional.Companion.absent
